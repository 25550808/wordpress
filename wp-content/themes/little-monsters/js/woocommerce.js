(function($){
	...
	$.OPAL_CountDown = function( obj, options ){
		...
		this.littlemonstersr  = null;
		this.element = obj;
		this.CountStepper = -1;
		this.CountStepper = Math.ceil(this.CountStepper);
		this.SetLittlemonstersOutPeriod = (Math.abs(this.CountStepper)-1)*1000 + 990;
	 ...
	 $.OPAL_CountDown.fn.extend({
		...
		CountBack:function( secs, self ){
			 if (secs < 0) {
			  ...
			  clearInterval(self.littlemonstersr);
			  ...
			  if (self.options.CountActive) {
				   self.littlemonstersr = null;
				 self.littlemonstersr =  setTimeout( function(){
					self.CountBack((secs+self.CountStepper),self);			
				},( self.SetLittlemonstersOutPeriod ) );
			 }
		}
