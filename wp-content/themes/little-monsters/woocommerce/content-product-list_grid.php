...
<div class="product-block-list no-space-row">
	<div class="product-block">
		<div class="media widget-product <?php echo esc_attr($class); ?> <?php echo (isset($item_order) && ($item_order%2)) ?'first':'last'; ?>" <?php echo trim($attrs); ?>>
			<div class="media-left">
				 <?php if($product->get_regular_price() > 0 && $product->get_sale_price()): ?>
					<span class="onsale">
	                    <?php
			...
			<div class="media-body">
				<div class="meta text-left">	
					...
					<?php do_action( 'amishop_woocommerce_before_shop_loop_item_title'); ?>			
				</div>
