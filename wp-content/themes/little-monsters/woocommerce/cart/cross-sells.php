...
if ($products->have_posts()) : ?>
    ...
    <div class="cross-sells">
        ...
        <h2><?php esc_html_e( 'You may be interested in&hellip;', 'little-monsters' ) ?></h2>
            ...
            <div class="owl-carousel-play">
                <div class="widget-content <?php echo isset( $style ) ? esc_attr( $style ) : ''; ?>">
                    <div class="owl-carousel " data-slide="<?php echo esc_attr( $columns_count ); ?>"
                             data-singleItem="true" data-navigation="true" data-pagination="false" data-tablet="[768, 1]" data-desktopsmall="[979, 1]" data-desktop = "[1199, 1]">
