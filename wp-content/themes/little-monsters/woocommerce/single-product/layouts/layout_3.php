...
<div id="product-<?php the_ID(); ?>" <?php post_class(); ?>>
    <div class="product-info clearfix single-layout3">
        ...
        <div class="row">
            <div class="col-md-6 col-sm-12">
                 ...
                 */
                add_action( 'woocommerce_before_single_product_summary', 'woocommerce_template_single_add_to_cart', 22 );
                remove_action( 'woocommerce_before_single_product_summary', 'littlemonsters_fnc_woocommerce_share_box', 23 );
