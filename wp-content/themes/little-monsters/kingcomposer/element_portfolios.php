...
<?php if ($loop->have_posts()): ?>
    ...
    <div id="filters" class="tab-v8 space-50">
        <div class="nav-inner">
            <ul class="nav nav-tabs isotope-filter categories_filter"
                data-related-grid="isotope-<?php echo esc_attr( $_id ); ?>">
                <?php

                echo '<li><a href="javascript:void(0)" class="active" title="" data-option-value=".all">' . esc_html__( 'All', 'little-monsters' ) . '</a></li>';
    ...
    <div class="isotope-masonry portfolio-entries clearfix masonry-spaced" data-isotope-duration="400"
         id="isotope-<?php echo esc_attr( $_id ); ?>">
