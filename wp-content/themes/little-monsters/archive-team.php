			 	...
			 	<div id="content" class="site-content" role="main">
			 				<?php if ( have_posts() ) : ?>
								...
								<?php the_posts_pagination( array(
									'prev_text'          => esc_html__( 'Previous page', 'little-monsters' ),
									'next_text'          => esc_html__( 'Next page', 'little-monsters' ),
									'before_page_number' => '<span class="meta-nav screen-reader-text">' . esc_html__( 'Page', 'little-monsters' ) . ' </span>',
								) ); ?>
							<?php else : ?>
