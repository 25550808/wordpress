    ...
    <div class="ih-item">
        ...
        <div class="info">
            <div class="info-inner">
                <h3><a class="text-white" href="<?php echo esc_url_raw( $image_attributes[0] ); ?>"
                       data-rel="prettyPhoto[pp_gal]"><?php the_title(); ?></a></h3>

                <div class="entry-category">
                    <?php esc_html_e( 'in', 'little-monsters' );
                    the_category(); ?>
                </div>
                <?php if (isset( $image_attributes[0] )): ?>
                    <a class="hidden zoom" href="<?php echo esc_url_raw( $image_attributes[0] ); ?>"
